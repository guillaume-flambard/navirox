...
import type { DiscoveredUnit, InspectContext, SourceInspection } from '@memolabs-apps/source'
import { declaredMajor, declaredRange, readManifest, testedMajors } from '@memolabs-apps/source'

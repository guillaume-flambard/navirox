...
| Item | Value |
| --- | --- |
| Command | `node packages/visual-benchmark/scripts/capture-records-native.mjs --platform ios --workspace /tmp/navirox-capture-final` |
...
| --- | --- | --- | --- |
| rest | `rest.ios.png` | 82864 | `3cb6fb6a808d4ea1e3996c20100f4bb111b0ca133351106f0905a3a4daad9cbf` |
...
| --- | --- | --- | --- |
| rest | `rest.ios.png` | 82864 | `3cb6fb6a808d4ea1e3996c20100f4bb111b0ca133351106f0905a3a4daad9cbf` |
| first-meaningful | `first-meaningful.ios.png` | 93240 | `21ea38fc88ccbf042b14c14d3bdc179d0e340a580f18f40846dac5b74fa26598` |
| midpoint | `midpoint.ios.png` | 90617 | `a14a19549d0553585b0d8ab72e6fa0fc3583732fa4b8b5d2d576a8cce56ff2db` |
| settled | `settled.ios.png` | 90617 | `a14a19549d0553585b0d8ab72e6fa0fc3583732fa4b8b5d2d576a8cce56ff2db` |
| interrupted | `interrupted.ios.png` | 90617 | `a14a19549d0553585b0d8ab72e6fa0fc3583732fa4b8b5d2d576a8cce56ff2db` |
...
Three motion frames share a hash. The fixture is a discrete state machine, so
`settled` presses the already selected row and `interrupted` replaces a pending
selection with the second row, and both land on the same state as `midpoint`. The
report names the frames that share a hash instead of presenting three states as
three measurements, and no frame is an in-flight interpolation: the target
compiler accepts no CSS transition, animation or transform, so the fixture has no
...
| Device capture | `rest.ios.png`, 1206 x 2622 px, 82864 bytes, `3cb6fb6a808d4ea1e3996c20100f4bb111b0ca133351106f0905a3a4daad9cbf` |

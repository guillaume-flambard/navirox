...
**Eleven adapters are at Experimental.** Vue 3, Nuxt, Svelte, SvelteKit, Angular,
React, Next, Astro, Solid, Qwik and Lit are detected and inspected, and nothing beyond that is claimed: no
